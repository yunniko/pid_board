...
class BoardRegistry
{
    private const BOARDS = [
        ['slug' => 'home',            'label' => 'SČ'],
        ['slug' => 'to_cakovice',     'label' => 'To SČ'],
        ['slug' => 'from_work_hv',    'label' => 'From work HV'],
        ['slug' => 'to_work_maddz',   'label' => 'To work MaDDz'],
        ['slug' => 'from_work_maddz', 'label' => 'From work MaDDz'],
    ];
    ...
    public function getBoardSettings(string $name): array
    {
